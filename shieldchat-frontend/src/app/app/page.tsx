...
export default function AppDashboard() {
  return (
    <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-950 via-gray-950 to-purple-950/20">
      <div className="text-center max-w-lg px-6">
        ...
        <div className="relative inline-block mb-8">
          ...
          <div className="absolute -top-2 -right-2 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-lg border-4 border-gray-950">
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 text-left">
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span className="text-gray-400">Create a channel or join an existing one from the sidebar</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span className="text-gray-400">Invite members with shareable invite links</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span className="text-gray-400">Send encrypted messages and attach private payments</span>
            </li>
          </ul>
        </div>
